...
├── colab_lightx2v_t2v.ipynb                                        # 纯 t2v + lightx2v 部署(无 ComfyUI;脚手架待真机核对)
...
- **可插拔、待按你的 ComfyUI 真机核对模板**：LTX-Video 2.3、S2V 对口型、一键转规格、视频换脸——均默认关 / 端点门控，节点名以各自 `comfyui_workflows/*.json` 模板为准，首跑前请按官方导出的 API 格式核对。
