...
from agent_lab.app.pipeline.gpu_client import GpuConfigError, GpuRunError

logger = get_logger("pipeline.comfy_http")

# __file__: <repo>/agent_lab/app/pipeline/comfy_http.py → 上溯 3 层到 <repo>
_REPO_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", ".."))
WORKFLOWS_DIR = os.path.join(_REPO_ROOT, "comfyui_workflows")
