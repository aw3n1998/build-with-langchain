...
class AgentRegistry:
    ...
    def discover_and_register(self):
        """
        动态扫描 mirage/app/agents 目录下的所有 python 文件。
        ...
        try:
            from mirage.app.agents.code_agent import build_code_subgraph
            from mirage.app.agents.file_agent import build_file_subgraph
            from mirage.app.agents.batch_agent import build_batch_graph
            from mirage.app.agents.general_agent import build_general_subgraph
            from mirage.app.agents.shell_agent import build_shell_subgraph
        ...
        for filepath in files:
            ...
            import_path = f"mirage.app.agents.{module_name}"
